    ...
    <nav class="navbar-main navbar-color nav-collapsible sideNav-lock navbar-dark gradient-45deg-indigo-purple no-shadow">
      <div class="nav-wrapper">
        ...
        <ul class="navbar-list right">
          ...
          <li><a class="waves-effect waves-block waves-light profile-button" href="javascript:void(0);" data-target="profile-dropdown"><span class="avatar-status avatar-online"><img src="{{ (!empty($user->profile_photo_path))? url('/storage/profile-photos/'.$user->profile_photo_path) : url('/storage/profile-photos/no_image.jpg') }}" alt="avatar"><i></i></span></a></li>
        ...
        <ul class="dropdown-content" id="profile-dropdown">
          <li><a class="grey-text text-darken-1" href="{{  route('profile.view') }}"><i class="material-icons">person_outline</i> Profile</a></li>
